...
#SBATCH --job-name sg2ada_wbc_m500_cond
...
RESULT_DIR=$PROJECT_DIR/results # specify output results dir for stylegan's train.py to generate
DATA_PATH=$PROJECT_DIR/wbc-256x256_m500.zip # path to dataset



echo "Workingdir: $PWD";
echo "=============================="
echo "Running StyleGAN3 Training"
